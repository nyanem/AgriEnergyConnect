...
namespace AgriEnergyConnect.Controllers
{
    public class FarmersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FarmerId,FullName,Email")] Farmer farmer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FarmerId,FullName,Email")] Farmer farmer)
        {
